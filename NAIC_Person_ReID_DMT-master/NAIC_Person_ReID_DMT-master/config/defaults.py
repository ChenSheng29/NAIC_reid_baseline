...
# -----------------------------------------------------------------------------
# Convention about Training / Test specific parameters 训练/测试的一些参数
# -----------------------------------------------------------------------------
...
#只要参数可以用于训练或测试，则对应的名称将以_TRAIN作为训练参数，或以_TEST作为测试专用参数后缀。
#例如，训练期间的图像数量将为IMAGES_PER_BATCH_TRAIN，而用于测试的图像数量将为IMAGES_PER_BATCH_TEST

# -----------------------------------------------------------------------------
# Config definition 配置
# -----------------------------------------------------------------------------
